...
# modify host name
sed -i 's/OpenWrt/T7/g' package/base-files/files/bin/config_generate
...
# switch ramips kernel to 5.15 (will not work mi4a_gigabit)
...
# set up WiFi with SSID:T7 PASS:00000000
sed -i 's/OpenWrt/T7/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
...
sed -i '/encryption/a\set wireless.default_radio${devidx}.key=00000000' package/kernel/mac80211/files/lib/wifi/mac80211.sh
#sed -i '/encryption/a\set wireless.default_radio${devidx}.key=coolphicomm' package/kernel/mac80211/files/lib/wifi/mac80211.sh

# modify login password to "root"
sed -i '/root/root:$1$4BuQtqHb$og6H6uywTEAnH8ndtzvYN.:19680:0:99999:7:::' package/base-files/files/etc/shadow
